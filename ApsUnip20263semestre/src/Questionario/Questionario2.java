...
public class Questionario2 extends JFrame {
	...
	public Questionario2() {
		...
		JLabel lblNewLabel = new JLabel("Odor: A água apresenta algum cheiro perceptível?");
		...
		//opções A, B, C
		JRadioButton RadA = new JRadioButton("(A) Não, é totalmente inodora.");
		...
		JRadioButton RadC = new JRadioButton("(C) Tem cheiro forte de enxofre, esgoto ou metal.");
