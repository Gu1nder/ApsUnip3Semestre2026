...
public class Questionario6 extends JFrame {
	 ...
	 */
	public static void Quest6(String[] args) {
	...
	public Questionario6() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Questionario7 q7 = new Questionario7();
			    Questionario6.this.dispose(); //Fechar a tela
			    q7.setVisible(true); //ir para a proxima tela(Sobre o programa)				   
