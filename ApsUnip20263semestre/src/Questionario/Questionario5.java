...
public class Questionario5 extends JFrame {
	 ...
	 */
	public static void Quest5(String[] args) {
	...
	public Questionario5() {
		...
		lblNewLabel.setBounds(95, 211, 631, 81);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Questionario6 q6 = new Questionario6();
			    Questionario5.this.dispose(); //Fechar a tela
			    q6.setVisible(true); //ir para a proxima tela(Sobre o programa)				   
