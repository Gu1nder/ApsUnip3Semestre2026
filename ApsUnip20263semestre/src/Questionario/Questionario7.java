...
public class Questionario7 extends JFrame {
	 ...
	 */
	public static void Quest7(String[] args) {
	...
	public Questionario7() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Questionario8 q8 = new Questionario8();
			    Questionario7.this.dispose(); //Fechar a tela
			    q8.setVisible(true); //ir para a proxima tela(Sobre o programa)				   
