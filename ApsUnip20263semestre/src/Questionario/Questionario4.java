...
public class Questionario4 extends JFrame {
	...
	public Questionario4() {
		...
		JLabel lblNewLabel = new JLabel("Origem do Abastecimento: De onde vem a água da sua residência?");
		lblNewLabel.setForeground(new Color(255, 255, 255));
		lblNewLabel.setBounds(95, 231, 664, 26);
		...
		//opções A, B, C
		JRadioButton RadA = new JRadioButton("(A) Rede pública de tratamento.");
		...
		JRadioButton RadB = new JRadioButton("(B) Poço artesiano protegido e profundo.");
		...
		JRadioButton RadC = new JRadioButton("(C) Poço raso, mina ou caminhão pipa sem procedência clara.");
