...
public class Questionario8 extends JFrame {
	 ...
	 */
	public static void Quest8(String[] args) {
	...
	public Questionario8() {
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				Questionario9 q9 = new Questionario9();
			    Questionario8.this.dispose(); //Fechar a tela
			    q9.setVisible(true); //ir para a proxima tela(Sobre o programa)				   
